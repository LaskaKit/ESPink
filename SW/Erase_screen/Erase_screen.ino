...
///GxEPD2_BW<GxEPD2_154_T8, GxEPD2_154_T8::HEIGHT> display(GxEPD2_154_T8(SS, DC, RST, BUSY)); // GDEW0154T8D, GDEW0154T8  152x152, UC8151 (IL0373)
...
GxEPD2_BW<GxEPD2_420, GxEPD2_420::HEIGHT> display(GxEPD2_420(SS, DC, RST, BUSY)); // GDEW042T2 400x300, UC8176 (IL0398)
